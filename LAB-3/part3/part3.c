...
//            printf("cents %d  input %d\n", remainder_cents, remainder_amount);
...
//            printf("dimes %d  remaining %d\n", dimes, remainder_amount);
...
//            printf("nickels %d  remaining %d\n", nickels, remainder_amount);
