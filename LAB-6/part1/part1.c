...
int main(void){
    ...
    char grid[8][8] = {{ 'H', 'N', 'E', 'P', 'N', 'H', 'H', 'D'},  // ROW 1
                       { 'E', 'S', 'J', 'E', 'S', 'S', 'E', 'Q' },  // ROW 2
                       { 'N', 'A', 'A', 'N', 'N', 'N', 'E', 'W' },  // ROW 3
                       { 'A', 'I', 'E', 'E', 'K', 'Y', 'N', 'T' },  // ROW 4
                       { 'R', 'J', 'F', 'L', 'J', 'Z', 'G', 'N' },  // ROW 5
                       { 'A', 'L', 'E', 'N', 'K', 'N', 'N', 'T' },  // ROW 6
                       { 'E', 'C', 'S', 'H', 'N', 'N', 'E', 'Q' },  // ROW 7
                       { 'N', 'H', 'D', 'N', 'T', 'N', 'E', 'J' }};    // ROW 8

    char word[5] = { 'J', 'E', 'N', 'S', 'H' };
